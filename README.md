...
| 3 | Prediction | `make_detections` | [here](scripts/make_detections.py) |
...
The `make_detections` command allows one to use the detection model trained at the previous step to make detections over various input datasets:
