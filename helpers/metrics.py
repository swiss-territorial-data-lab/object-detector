...
def get_fractional_sets(dets_gdf, labels_gdf, iou_threshold=0.25, area_threshold=50):
    """
    ...
    Args:
        ...
        area_threshold (float): threshold applied on clipped label and detection polygons to discard the smallest ones. Default 50m²
    Raises:
